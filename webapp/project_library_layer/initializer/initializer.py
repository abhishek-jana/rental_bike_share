...
class Initializer():
    ...
    def get_training_batch_file_path(self, project_id):
        try:
            ...
            ), self.get_project_collection_name(), {'project_id': project_id})
            ...
            if project_name is None:
                message = 'Project name not found failed in initializer.py method {}'.format(
                    self.get_training_batch_file_path.__name__)
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_training_path,
                                     project_name, "training_batch_files")
            return path
        except Exception as e:
            raise e
    ...
    def get_project_report_graph_file_path(self, project_id, execution_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_graph_path, project_name,
                                     self.get_time_stamp_as_file_name_of_execution_id(execution_id))
            return path
        except Exception as e:
            raise e
        ...
        try:
            ...
            if project_name is None:
                message = 'Project name not found failed in initializer.py method {}'.format(
                    self.get_prediction_batch_file_path.__name__)
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_prediction_path,
                                     project_name, "prediction_batch_files")
            return path
        except Exception as e:
            raise e
    ...
    def get_training_good_raw_data_file_path(self, project_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_training_path,
                                     project_name, "good_raw_data_files")
            return path
        except Exception as e:
            raise e
    ...
    def get_training_bad_raw_data_file_path(self, project_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_training_path,
                                     project_name, "bad_raw_data_files")
            return path
        except Exception as e:
            raise e
        ...
        try:
            ...
            if project_name is None:
                message = 'Project name not found failed in initializer.py method {}'.format(
                    self.get_training_archive_bad_raw_data_file_path.__name__)
                raise Exception(message)
            path = "{}/{}/{}".format(root_archive_training_path,
                                     project_name, "bad_raw_data_files")
            return path
        except Exception as e:
            raise e
        ...
        try:
            ...
            if project_name is None:
                message = 'Project name not found failed in initializer.py method {}'.format(
                    self.get_prediction_archive_bad_raw_data_file_path.__name__)
                raise Exception(message)
            path = "{}/{}/{}".format(root_archive_prediction_path,
                                     project_name, "bad_raw_data_files")
            return path
        except Exception as e:
            raise e
    ...
    def get_training_good_raw_data_collection_name(self, project_id):
        try:
            ...
            collection_name = "{}_{}_{}".format(
                project_name, "good_raw_data", project_id)
    ...
    def get_training_file_from_db_path(self, project_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_training_path,
                                     project_name, "training_file_from_db")
            return path
        except Exception as e:
            raise e
    ...
    def get_prediction_file_from_db_path(self, project_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_prediction_path,
                                     project_name, "prediction_file_from_db")
            return path
        except Exception as e:
            raise e
    ...
    def get_training_preprocessing_data_path(self, project_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_training_path,
                                     project_name, "preprocessing_data")
            return path
        except Exception as e:
            raise e
    ...
    def get_prediction_output_file_path(self, project_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_prediction_path,
                                     project_name, "prediction_output_file")
            return path
        except Exception as e:
            raise e
    ...
    def get_encoded_column_name_file_path(self, project_id):
        try:
            ...
            if project_name is None:
                ...
                raise Exception(message)
            path = "{}/{}/{}".format(root_file_training_path,
                                     project_name, "encoder_column_name")
            return path
        except Exception as e:
            raise e
